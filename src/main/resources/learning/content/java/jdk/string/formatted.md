---
id: java/jdk/string/formatted
title: String.formatted()
concept: string-formatted
kind: method
sourceMember: formatted
level: beginner
duration: 2
category: API JAVA
...
Usa formatted() em String para realizar a operação indicada pela API Java.

```java
String texto = "EyeCode";
var resultado = texto.formatted();
```
