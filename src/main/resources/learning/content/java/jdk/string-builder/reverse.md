---
id: java/jdk/string-builder/reverse
title: StringBuilder.reverse()
concept: string-builder-reverse
kind: method
sourceMember: reverse
sourceSignature: ()
level: beginner
duration: 2
category: API JAVA
...
Usa reverse() em StringBuilder para realizar a operação indicada pela API Java.
