---
id: java/jdk/stream/none-match
title: Stream.noneMatch()
concept: stream-none-match
kind: method
sourceMember: noneMatch
level: beginner
duration: 2
category: API JAVA
...
Usa noneMatch() em Stream para realizar a operação indicada pela API Java.

```java
Stream<String> valores = List.of("Ada", "Lin").stream();
var resultado = valores.noneMatch(texto -> texto.isBlank());
```
