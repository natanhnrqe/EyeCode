---
id: java/jdk/list/sub-list
title: List.subList()
concept: list-sub-list
kind: method
sourceMember: subList
level: beginner
duration: 2
category: COLEÇÕES
...
Usa subList() em List para realizar a operação indicada pela API Java.

```java
List<String> valores = new ArrayList<>(List.of("Ada"));
var resultado = valores.subList(0, 1);
```
