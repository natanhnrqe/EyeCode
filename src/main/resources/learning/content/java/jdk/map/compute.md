---
id: java/jdk/map/compute
title: Map.compute()
concept: map-compute
kind: method
sourceMember: compute
level: beginner
duration: 2
category: COLEÇÕES
parent: java/jdk/map
...
Usa compute() em Map para realizar a operação indicada pela API Java.

```java
Map<String, Integer> valores = new HashMap<>();
var resultado = valores.compute("Ada", (chave, valor) -> 1);
```
