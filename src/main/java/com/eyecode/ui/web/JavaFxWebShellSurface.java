...
/**
 * JavaFX/CEFFX implementation of the Web Shell surface. It owns browser
 * lifecycle and JavaFX thread adaptation while sharing the Web protocol with
 * the other shell transports.
 */
public final class JavaFxWebShellSurface extends Region implements WebShellSurface {
