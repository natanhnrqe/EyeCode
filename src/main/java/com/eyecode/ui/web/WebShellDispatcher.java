...
/**
 * In-process registry for Web Shell channel/name handlers. Registration is an
 * adapter concern; the dispatcher maps only one exact pair and returns a
 * structured unknown-command error for unmatched requests.
 */
