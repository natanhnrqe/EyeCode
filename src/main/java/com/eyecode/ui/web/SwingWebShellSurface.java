...
/**
 * Legacy Swing/JCEF implementation of the Web Shell surface. It is kept for
 * compatibility and owns only Swing/JCEF lifecycle details; protocol and
 * workspace behavior remain in the shared Web adapter.
 */
