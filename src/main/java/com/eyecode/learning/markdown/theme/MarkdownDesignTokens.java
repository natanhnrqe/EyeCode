...
public final class MarkdownDesignTokens {

    private MarkdownDesignTokens() {
    }
    ...
    public static final int LINK_SPACE_ABOVE = 12;
    public static final int LINK_SPACE_BELOW = 6;
    public static final int ARROW_SPACE_ABOVE = 10;
    public static final int ARROW_SPACE_BELOW = 10;
    ...
    public static final int CALLOUT_LEFT_INDENT = 16;
    public static final int CALLOUT_SPACE_BELOW = 14;
    public static final int CALLOUT_TITLE_SPACE_ABOVE = 10;
    public static final int CALLOUT_TITLE_SPACE_BELOW = 2;
    public static final int CALLOUT_BODY_SPACE_ABOVE = 2;
    public static final int CALLOUT_BODY_SPACE_BELOW = 14;

    // ── Responsive Content Margins ──────────────────

    public static final int CONTENT_MARGIN_SMALL = 16;
    public static final int CONTENT_MARGIN_MEDIUM = 24;
    public static final int CONTENT_MARGIN_LARGE = 40;
    public static final int CONTENT_MARGIN_XLARGE = 64;
}
