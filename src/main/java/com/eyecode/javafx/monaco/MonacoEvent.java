...
public record MonacoEvent(Type type, String modelId, String content, long version,
                          ...
                          int targetStartOffset, int targetEndOffset, String targetText) {
    ...
    public static MonacoEvent ready() {
        return new MonacoEvent(Type.READY, null, null, 0, 0, 0, 0, 0, 0, 0, null, 0, 0, null);
    }

    public static MonacoEvent contentChanged(String id, String content, long version) {
        return new MonacoEvent(Type.CONTENT_CHANGED, id, content, version, 0, 0, 0, 0, 0, 0, null, 0, 0, null);
    }
    ...
    public static MonacoEvent hover(String id, long version, int line, int column,
                                    double x, double y) {
        return hover(id, version, line, column, x, y, 0, 0, null);
    }

    public static MonacoEvent hover(String id, long version, int line, int column,
                                    double x, double y, int startOffset, int endOffset, String text) {
    ...
    public static MonacoEvent hoverExit(String id, long version) {
        return new MonacoEvent(Type.HOVER_EXIT, id, null, version, 0, 0, 0, 0, 0, 0, null, 0, 0, null);
    }
