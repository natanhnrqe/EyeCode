...
public final class ExperimentA_MinimalEditor {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Exp A — Minimal Editor + Hover + CEF");
            ...
            System.out.println("=== EXP A READY ===");
            System.out.println("1. Hover over 'interface' or 'class' keywords");
            System.out.println("2. Scroll with mouse wheel");
            System.out.println("3. Observe: popup flash, scroll, focusLost");
        });
    }
