...
class SymbolTest {
    ...
    void immutableFields() {
        SymbolId id = SymbolId.of(1, 10, 20, SymbolKind.TYPE);
        TextRange range = TextRange.of(10, 20);
        Symbol symbol = new Symbol(id, SymbolKind.TYPE, "Foo", range, 0, 0, "Foo");
    ...
    void nullIdRejected() {
        ...
        assertThrows(NullPointerException.class,
                () -> new Symbol(null, SymbolKind.TYPE, "Foo", range, 0, 0, "Foo"));
    }
    ...
    void nullKindRejected() {
        ...
        TextRange range = TextRange.of(10, 20);
        assertThrows(NullPointerException.class,
                () -> new Symbol(id, null, "Foo", range, 0, 0, "Foo"));
    }
    ...
    void nullNameRejected() {
        ...
        TextRange range = TextRange.of(10, 20);
        assertThrows(NullPointerException.class,
                () -> new Symbol(id, SymbolKind.TYPE, null, range, 0, 0, "Foo"));
    }
    ...
    void nullRangeRejected() {
        SymbolId id = SymbolId.of(1, 10, 20, SymbolKind.TYPE);
        assertThrows(NullPointerException.class,
                () -> new Symbol(id, SymbolKind.TYPE, "Foo", null, 0, 0, "Foo"));
    }
    ...
    void ownerScopeIdAccessible() {
        SymbolId id = SymbolId.of(1, 10, 20, SymbolKind.TYPE);
        TextRange range = TextRange.of(10, 20);
        Symbol symbol = new Symbol(id, SymbolKind.TYPE, "Foo", range, 42, 42, "Foo");
    ...
    void qualifiedNameAccessible() {
        SymbolId id = SymbolId.of(1, 10, 20, SymbolKind.TYPE);
        TextRange range = TextRange.of(10, 20);
        Symbol symbol = new Symbol(id, SymbolKind.TYPE, "Foo", range, 0, 0, "com.example.Foo");
